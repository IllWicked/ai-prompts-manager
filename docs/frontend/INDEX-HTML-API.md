...
Справочник функций приложения. Общее количество ~373 функций в 34 модулях (включая внутренние). В таблице ниже — **публичные API функции** (~102), сгруппированные по категориям.
